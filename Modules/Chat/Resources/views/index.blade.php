                ...
                <div class="container">
                    <div class="inside">
                        <div class="nav nav-tab menu">
                            <button class="btn"><img class="avatar-xl" src="{{ Auth::user()->avatar_url }}" alt="avatar"></button>
                    ...
                    <div class="col-md-12">
                        <div class="tab-content">
                                ...
                                <div class="discussions">
                                    ...
                                    <div class="list-group" id="chats" role="tablist">
                                        <a href="#list-chat" class="filterDiscussions all unread single active" id="list-chat-list" data-toggle="list" role="tab">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-1.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
                                            <div class="status">
                                        ...
                                        <a href="#list-empty" class="filterDiscussions all unread single" id="list-empty-list" data-toggle="list" role="tab">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-male-1.jpg') }}" data-toggle="tooltip" data-placement="top" title="Michael" alt="avatar">
                                            <div class="status">
                                        ...
                                        <a href="#list-chat" class="filterDiscussions all read single" id="list-chat-list2" data-toggle="list" role="tab">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-2.jpg') }}" data-toggle="tooltip" data-placement="top" title="Lean" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                        ...
                                        <a href="#list-empty" class="filterDiscussions all read single" id="list-empty-list2" data-toggle="list" role="tab">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-male-2.jpg') }}" data-toggle="tooltip" data-placement="top" title="Mariette" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                        ...
                                        <a href="#list-chat" class="filterDiscussions all read single" id="list-chat-list3" data-toggle="list" role="tab">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-3.jpg') }}" data-toggle="tooltip" data-placement="top" title="Harmony" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons online">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                        ...
                                        <a href="#list-request" class="filterDiscussions all unread single" id="list-request-list" data-toggle="list" role="tab">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-6.jpg') }}" data-toggle="tooltip" data-placement="top" title="Louis" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                        ...
                                        <a href="#list-empty" class="filterDiscussions all read single" id="list-empty-list4" data-toggle="list" role="tab">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-male-3.jpg') }}" data-toggle="tooltip" data-placement="top" title="Ryan" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                        ...
                                        <a href="#list-chat" class="filterDiscussions all unread single" id="list-chat-list5" data-toggle="list" role="tab">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-male-4.jpg') }}" data-toggle="tooltip" data-placement="top" title="Mildred" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                            ...
                            <div id="notifications" class="tab-pane fade">
                                ...
                                <div class="notifications">
                                    ...
                                    <div class="list-group" id="alerts" role="tablist">
                                        ...
                                        <a href="#" class="filterNotifications all latest notification" data-toggle="list">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-3.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons online">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                        ...
                                        <a href="#" class="filterNotifications all oldest notification" data-toggle="list">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-5.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                        ...
                                        <a href="#" class="filterNotifications all oldest notification" data-toggle="list">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-2.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                        ...
                                        <a href="#" class="filterNotifications all oldest notification" data-toggle="list">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-male-3.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                        ...
                                        <a href="#" class="filterNotifications all oldest notification" data-toggle="list">
                                            <img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-male-4.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                            ...
                            <div class="tab-pane fade" id="settings">
                                <div class="settings">
                                    <div class="profile">
                                        <img class="avatar-xl" src="{{ asset('chat-assets/img/avatars/avatar-male-1.jpg') }}" alt="avatar">
                                    ...
                                    <div class="categories" id="accordionSettings">
                                        ...
                                        <div class="category">
                                            ...
                                            <div class="collapse" id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionSettings">
                                                <div class="content">
                                                    <div class="upload">
                                                        <div class="data">
                                                            <img class="avatar-xl" src="{{ asset('chat-assets/img/avatars/avatar-male-1.jpg') }}" alt="image">
                                                            <label>
                                                                <input type="file">
                                        ...
                                        <div class="category">
                                            ...
                                            <div class="collapse" id="collapseFour" aria-labelledby="headingFour" data-parent="#accordionSettings">
                                                <div class="content">
                                                    <div class="app">
                                                        <img src="chat-assets/img/integrations/slack.svg" alt="app">
                                                    ...
                                                    <div class="app">
                                                        <img src="chat-assets/img/integrations/dropbox.svg" alt="app">
                                                        <div class="permissions">
                                                            <h5>Dropbox</h5>
                                                    ...
                                                    <div class="app">
                                                        <img src="chat-assets/img/integrations/drive.svg" alt="app">
                                                        <div class="permissions">
                                                            <h5>Google Drive</h5>
                                                    ...
                                                    <div class="app">
                                                        <img src="chat-assets/img/integrations/trello.svg" alt="app">
                                                        <div class="permissions">
                                                            <h5>Trello</h5>
                                                            <p>No permissions set</p>
                                                        </div>
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <div class="user" id="contact">
                                        <img class="avatar-sm" src="{{ asset('chat-assets/img/avatars/avatar-female-5.jpg') }}" alt="avatar">
                                        <h5>Keith Morris</h5>
                        ...
                        <div class="chat" id="chat1">
                            <div class="top">
                                <div class="container">
                                    <div class="col-md-12">
                                        <div class="inside">
                                            <a href="#"><img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-5.jpg') }}" data-toggle="tooltip" data-placement="top" title="Keith" alt="avatar"></a>
                                            <div class="status">
                                                <i class="material-icons online">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                    ...
                                    <div class="col-md-12">
                                        <div class="inside">
                                            <div class="participant">
                                                <img class="avatar-xxl" src="{{ asset('chat-assets/img/avatars/avatar-female-5.jpg') }}" alt="avatar">
                        ...
                        <div class="chat" id="chat2">
                            <div class="top">
                                <div class="container">
                                    <div class="col-md-12">
                                        <div class="inside">
                                            <a href="#"><img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-2.jpg') }}" data-toggle="tooltip" data-placement="top" title="Lean" alt="avatar"></a>
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                            ...
                            <div class="content">
                                <div class="container">
                                    <div class="col-md-12">
                                        <div class="inside">
                                            <div class="participant">
                                                <img class="avatar-xxl" src="{{ asset('chat-assets/img/avatars/avatar-female-2.jpg') }}" alt="avatar">
                                                <span>Connecting</span>
                                            </div>
                                            <div class="options">
                                                <button class="btn option"><i class="material-icons md-30">mic</i></button>
                        ...
                        <div class="chat" id="chat3">
                            <div class="top">
                                <div class="container">
                                    <div class="col-md-12">
                                        <div class="inside">
                                            <a href="#"><img class="avatar-md" src="{{ asset('chat-assets/img/avatars/avatar-female-6.jpg') }}" data-toggle="tooltip" data-placement="top" title="Louis" alt="avatar"></a>
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                            <div class="data">
                                ...
                                <div class="container">
                                    <div class="col-md-12">
                                        <div class="no-messages request">
                                            <a href="#"><img class="avatar-xl" src="{{ asset('chat-assets/img/avatars/avatar-female-6.jpg') }}" data-toggle="tooltip" data-placement="top" title="Louis" alt="avatar"></a>
